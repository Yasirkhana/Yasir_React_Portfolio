...
import { HeaderGif } from "../assets/assets";
        ...
        <div className="row header-items g-0">
          <div className="col-lg-6 header-text">
            ...
            <div className="header-buttons">
              ...
              <Link className="inline-items" to="https://drive.google.com/file/d/1cEnoYJdg1QfHEkjSAq8ks2ufQ0wbyLRn/view?usp=sharing">
                <BlogsButton />
              </Link>
            </div>
          </div>
          <div className="col-lg-6 header-img">
            <Fade keyframes={fadeInDownShorter} duration={500} delay={700}>
              <img className="header-image" src={HeaderGif} alt="" />
            </Fade>
          </div>
        </div>
      </div>
